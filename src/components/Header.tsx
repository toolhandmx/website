import { toggleTheme, toggleMenu } from "../utils";
      ...
      <div className="wrapper">
          ...
          <div className="logo">
            <svg viewBox="0 0 1660 256" height="2rem">
              ...
              <path
                ...
                fill="var(--color-primary-black-900)"
              />
            </svg>
          </div>
        </div>
        <div className="end">
          ...
          <button className="theme-toggle" onClick={toggleTheme}>
            <i id="sun" className="ri-sun-line" />
            <i id="moon" className="ri-moon-line" />
          </button>
          <button className="menu-toggle" onClick={toggleMenu}>
            <i id="show-menu" className="ri-menu-line" />
            <i id="hide-menu" className="ri-close-line" />
          </button>
        </div>
      </div>
    </header>
